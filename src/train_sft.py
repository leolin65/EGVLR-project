# [Stage I / Stage II] Supervised fine-tuning entrypoint (PVE-FT and KG-IT both use this;
# they differ only in --data_path/--image_folder and which layers are frozen — see
# finetune_stage1_pve_ft.sh / finetune_stage2_kg_it.sh).
#
