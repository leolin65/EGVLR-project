# [Stage II: KG-IT] Merges the three KG-IT sources into one training file.
# Originally: Stage2_Dataset/merge_json.py
# Combines domain-knowledge QA + comparative QA + one-normal visual QA,
# optionally repeating the smaller sources to rebalance their share of
# the final mix (see --repeat_json1 and README's data-mix section).
...
python merge_stage_dataset.py \
  --json1 /home/psmc2/project/dataset/Stage2_Dataset/comp_stage2.json \
  --json2 /home/psmc2/project/dataset/Stage2_Dataset/stage2.json \
  --output /home/psmc2/project/dataset/Stage2_Dataset/stage2.json \
  --repeat_json1 4 \
  --unique_repeat_id \
  --shuffle \
  --seed 42
