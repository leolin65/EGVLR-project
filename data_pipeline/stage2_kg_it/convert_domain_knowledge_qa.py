# [Stage II: KG-IT] Domain-knowledge MCQ converter.
# Originally: Stage2_Dataset/read_judo.py
# Converts single-image domain-knowledge MCQ (object/defect terminology,
# functional risk) into the EDDP schema. No <location> field is ever
# populated here (validated at the end of the script) since these are
...
python convert_domain_knowledge_qa.py \
  --input_json /home/psmc2/project/dataset/Stage2_Dataset/judo_domain_qa_mcq_dk_ultra_strict_flat.jsonl \
  --src_root /home/psmc2/project/dataset/MMAD \
  --dst_root /home/psmc2/project/dataset/Stage2_Dataset \
  --output_json /home/psmc2/project/dataset/Stage2_Dataset/train_stage2.json \
  --long_edge 256 \
  --skip_missing
"""
