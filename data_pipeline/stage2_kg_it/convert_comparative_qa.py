# [Stage II: KG-IT] Comparative-inspection QA converter.
# Originally: Stage2_Dataset/read_comp.py
# Converts the 'comparative inspection' flat QA source into the EDDP
# <think><evidence>/<logic></think><answer><location> schema, resizing
# images and copying them from the MMAD root as needed.
...
python convert_comparative_qa.py \
  --input /home/psmc2/project/dataset/Stage2_Dataset/comparative_inspection_stage2_mix_15pct_normal_flat.jsonl \
  --output comp_stage2.json \
  --stage2_root /home/psmc2/project/dataset/Stage2_Dataset \
